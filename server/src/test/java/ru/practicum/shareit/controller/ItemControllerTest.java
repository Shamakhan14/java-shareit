...
public class ItemControllerTest {
    ...
    @Test
    void createNameNullTest() throws Exception {
    ...
    @Test
    void createAvailableNullTest() throws Exception {
    ...
    @Test
    void postNullTest() throws Exception {
        CommentDtoInc commentDtoInc = new CommentDtoInc(null);
